...
namespace Tyuiu.KozachokNA.IndividualTasks.Task7.V8
{
    public partial class Drivers : Form
    {
        ...
        public Drivers()
        {
            ...
            Table = DriversTable;
            AddRowField = DriversAddRowField;
            DeleteRowField = DriversDeleteRowField;
            SearchField = DriversSearchField;
            m = 5; //5 для Drivers, 6 для Runs, 7 для Cars
        ...
        private void DriversSearch_Click(object sender, EventArgs e)
        {
        ...
        private void DriversRefresh_Click(object sender, EventArgs e)
        {
            ...
            double years = Math.Round((double)DataService.Summator(csv, 3) / count, 3);
            AvrYears.Text = Convert.ToString(years);
            double money = Math.Round((double)DataService.Summator(csv, 4) / count, 3);
            AvrMoney.Text = Convert.ToString(money);
        }
    }
}
